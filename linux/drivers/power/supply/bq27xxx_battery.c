...
#if 1 /* IML */
static struct bq27xxx_dm_reg bq27510g3_dm_regs[] = {
	[BQ27XXX_DM_DESIGN_CAPACITY]   = { 48, 10, 2,    0, 65535 },
	[BQ27XXX_DM_DESIGN_ENERGY]     = { }, /* missing on chip */
	[BQ27XXX_DM_TERMINATE_VOLTAGE] = { 80, 46, 2, 1000, 32767 },
};
#else
...
static struct {
	...
	[BQ27510G3] = BQ27XXX_DATA(bq27510g3, 0x04143672, BQ27XXX_O_OTDC),
...
static void bq27xxx_battery_settings(struct bq27xxx_device_info *di)
{
	...
	bool is_valid = max != 0;
	if (is_valid && info->energy_full_design_uwh > max * 1000) {
